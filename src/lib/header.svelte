<script>
	...
	// INFO: gets store of page and records it for use on header
	page.subscribe((value) => {
		pageValue = value;
	});
</script>

<!-- INFO: On desktop space on name and chevron is removed and in mobile name and Page are separated  -->
